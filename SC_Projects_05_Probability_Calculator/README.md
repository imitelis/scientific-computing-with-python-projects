# freeCodeCamp - Scientific Computing with Python - Projects - V - Probability Calculator - Instructions


## 5. Projects - Probability Calculator
...
<em>Hint: Consider using the modules that are already imported at the top of `prob_calculator.py`. Do not initialize random seed within `prob_calculator.py`.</em>
